...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/test/testDataChild/">testc列表</a></li>
		<li class="active"><a href="${ctx}/test/testDataChild/form?id=${testDataChild.id}">testc<shiro:hasPermission name="test:testDataChild:edit">${not empty testDataChild.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="test:testDataChild:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
