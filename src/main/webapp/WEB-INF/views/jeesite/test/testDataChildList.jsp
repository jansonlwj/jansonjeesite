...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/test/testDataChild/">testc列表</a></li>
		<shiro:hasPermission name="test:testDataChild:edit"><li><a href="${ctx}/test/testDataChild/form">testc添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="testDataChild">
			<tr>
				...
				<shiro:hasPermission name="test:testDataChild:edit"><td>
					...
					<a href="${ctx}/test/testDataChild/delete?id=${testDataChild.id}" onclick="return confirmx('确认要删除该testc吗？', this.href)">删除</a>
